...
/*
 * Lab history:
 * - Lab 5: aplicatie demo pentru StudentBursier.
 * - Lab 6: logica de sortare validata prin teste unitare.
 */
...
public class AplicatieCuBursa {
    ...
    public List<StudentBursier> sorteaza(List<StudentBursier> lst) {
        List<StudentBursier> rezultat = new ArrayList<>(lst);
        rezultat.sort(Comparator.comparing(StudentBursier::getFormatieDeStudiu)
